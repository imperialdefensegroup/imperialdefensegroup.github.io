---
layout: post
title: "Glock Gen6: la evolución de una plataforma que se resistía a cambiar"
date: 2026-09-14
permalink: /articulos/glock-gen6-evolucion/
description: "La evolución de Glock hasta la Gen6: nueva ergonomía, disparador plano, sistema óptico ORS y versiones A-CUT con Aimpoint COA."
categories: [armamento, pistolas, Glock]
tags: [Glock Gen6, Glock Gen 6, evolución Glock, ORS, Aimpoint COA, Safe Action]
image: /assets/img/glock-gen6.png
thumbnail: /assets/img/glock-gen6.png
interview_dark: true
---

![Pistolas Glock con ópticas de punto rojo]({{ "/assets/img/glock-gen6.png" | relative_url }})

**Más de cuatro décadas después de la aparición de la Glock 17 original, la sexta generación supone uno de los cambios más importantes experimentados por la plataforma. La Gen6 conserva la arquitectura mecánica y el sistema Safe Action que convirtieron a Glock en un estándar mundial, pero modifica precisamente los aspectos en los que sus competidores habían conseguido reducir distancias: ergonomía, disparador y montaje de ópticas.**

Cuando Gaston Glock desarrolló a principios de los años ochenta la pistola que terminaría convirtiéndose en la **Glock 17**, probablemente era difícil anticipar hasta qué punto aquel diseño transformaría el mercado de las armas cortas de servicio.

Armazón de polímero, aguja lanzada, gran capacidad, pocos componentes, tres seguros automáticos y una filosofía basada en la simplicidad mecánica dieron lugar a una plataforma que acabaría siendo adoptada por fuerzas policiales y militares de todo el mundo.
...
La evolución de Glock se entiende mejor observando qué problema intentó solucionar cada generación.

La **primera generación**, producida desde comienzos de los años ochenta, estableció prácticamente toda la arquitectura fundamental de la pistola: armazón de polímero, sistema Safe Action, cargador de doble columna y una construcción extremadamente sencilla.
...
| Generación | Introducción | Evolución principal |
| --- | --- | --- |
| **Gen1** | 1980-1982 | Concepto original Safe Action |
| **Gen2** | 1988 | Nueva textura y geometría del armazón |
| **Gen3** | 1998 | Raíl de accesorios y finger grooves |
| **Gen4** | 2009 | Backstraps, RTF, retenida reversible y doble muelle |
| **Gen5** | 2017 | GMB, ambidiestra, sin finger grooves, nDLC |
| **Gen6** | 2026 | Nueva ergonomía, disparador plano y nuevo sistema óptico |

Pero la Gen6 introduce una diferencia conceptual respecto a muchas de esas generaciones.

Glock ya no está simplemente modificando su propia pistola. Está respondiendo a un mercado de pistolas de polímero que la propia compañía ayudó a crear y en el que actualmente existe una competencia extraordinariamente sofisticada.

## El verdadero cambio de la Gen6: la ergonomía

Durante décadas probablemente la crítica más repetida contra Glock no estuvo relacionada con su fiabilidad, sino con su ergonomía.

La peculiar inclinación de la empuñadura, su perfil relativamente rectangular y la geometría del guardamonte funcionaban, pero fabricantes como Walther, CZ, Heckler & Koch, SIG Sauer o Springfield Armory comenzaron a ofrecer armazones considerablemente más elaborados.

En la Gen6 Glock ha atacado directamente esta cuestión.
...
También cambia considerablemente la textura.
...
## El nuevo disparador plano

Otro cambio inmediatamente visible es el disparador.

Por primera vez en una generación estándar, la Glock Gen6 incorpora de fábrica un **flat-faced trigger**, abandonando el tradicional perfil curvado asociado durante décadas a las Glock de servicio.

Sin embargo, conviene hacer una distinción importante.

**No estamos ante un Glock Performance Trigger instalado de serie.**
...
## Adiós al MOS tradicional

El segundo gran cambio tecnológico se encuentra encima de la corredera.

La expansión de los red dot ha transformado el mercado de las pistolas de servicio y Glock fue relativamente temprana introduciendo su sistema **MOS — Modular Optic System — en 2016**.

Pero el MOS también presentaba limitaciones.

El sistema utilizaba una placa intermedia que aumentaba la altura de instalación del visor y añadía otra interfaz mecánica entre corredera y óptica.
...
Esto permite reducir el conjunto y modificar el posicionamiento del visor.

### ¿Es perfecto el nuevo ORS?
...
Y existe además otra solución dentro del propio catálogo Glock.

## A-CUT y Aimpoint COA: posiblemente la solución más interesante

Paralelamente al sistema ORS, Glock mantiene su colaboración con Aimpoint mediante el **A-CUT**.

En esta configuración el Aimpoint COA se instala directamente sobre la corredera mediante un sistema de cuña, eliminando completamente la necesidad de placas adaptadoras.

El visor queda situado muy bajo respecto a la corredera y la unión mecánica entre ambos componentes es especialmente robusta.

Actualmente Glock ofrece versiones Gen6 COA de la:
...
## También hay cambios internos

Externamente la Gen6 continúa siendo inequívocamente una Glock.

Internamente las diferencias son mayores de lo que inicialmente podría parecer.
...
Continúan existiendo componentes comunes y, especialmente importante desde una perspectiva logística, **se mantiene la compatibilidad con los cargadores Gen5**.

Para organismos policiales con grandes parques de armas, esa continuidad puede resultar casi tan importante como cualquier mejora mecánica.

## La gama Gen6 continúa creciendo

En su presentación de diciembre de 2025 Glock anunció inicialmente tres modelos, todos ellos en 9 × 19 mm:

**G17 Gen6**, como pistola de tamaño completo.
...
Con dos longitudes fundamentales de armazón y dos longitudes de corredera Glock puede cubrir prácticamente las cuatro combinaciones más demandadas dentro de una misma arquitectura.

## Una transición estratégica, no simplemente una nueva generación
...
Es el comienzo de la siguiente arquitectura principal de Glock.

Y resulta particularmente revelador observar dónde ha concentrado la compañía sus recursos.

Glock **no ha sustituido el sistema Safe Action**, no ha introducido un chasis modular serializado al estilo SIG P320 ni ha intentado reinventar radicalmente su mecanismo.

En cambio, ha trabajado sobre:

**ergonomía + control + interfaces ópticas + adaptación al usuario.**

Precisamente los terrenos en los que el mercado había evolucionado más rápidamente durante la última década.

## ¿Revolución o evolución?

Probablemente ninguna palabra describe mejor a la Glock Gen6 que **evolución**.

La Gen6 no rompe con la pistola diseñada por Gaston Glock hace más de cuarenta años. De hecho, continúa utilizando muchos de los principios que hicieron extraordinariamente exitosa aquella arma.

Pero probablemente sea una de las generaciones en las que Glock ha aceptado modificar más profundamente la interacción entre arma y tirador.

La Gen3 adaptó Glock a los accesorios.

La Gen4 comenzó a adaptar Glock a diferentes usuarios.

La Gen5 mejoró precisión, ambidextría y durabilidad.

Y la **Gen6 intenta integrar definitivamente ergonomía y óptica dentro del diseño original de la plataforma**.

Ese puede acabar siendo su cambio más importante.

Porque la mayor evolución de la Glock Gen6 quizá no esté en ninguna pieza concreta.

Está en que, después de décadas obligando en cierta medida al usuario a adaptarse a la pistola, **Glock parece haber decidido finalmente adaptar la pistola al usuario**.
